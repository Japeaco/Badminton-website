...
<nav class="nav">
  ...
  <ul class="navbar-nav">
	...
	<li class="nav-item">
      <a class="nav-link" href="racketServices.php" style="color:#006680">Racket Stringing Services</a>
    </li>
	<li class="nav-item">
...
<h1 class="titleText">Racket Stringing Services</h1>

<div class="homeText">
  <p>Eventually, your racket will need restringing; the tension reduces over time and strings can break. 
     We can offer re-stringing services locally with a variety of string types and a tension of your choosing.
     Contact John on 01262 and offer a shitload of money.</p>
</div>
